...
const THEMES = [\
  \{ \
    ...
    avatar: '\uc0\u55357 \u56362 ',\
    avatarName: (gender) => gender === 'male' ? '\uc0\u1502 \u1500 \u1498  \u1492 \u1502 \u1491 \u1489 \u1512 ' : '\u1502 \u1500 \u1499 \u1514  \u1492 \u1502 \u1491 \u1489 \u1512 ',\
    prize: '\uc0\u55356 \u57141 '\
  \},\
  \{ \
    id: 2, \
    ...
    avatar: '\uc0\u55357 \u56424 \u8205 \u55357 \u56960 ',\
    avatarName: (gender) => gender === 'male' ? '\uc0\u1488 \u1505 \u1496 \u1512 \u1493 \u1504 \u1488 \u1493 \u1496 ' : '\u1488 \u1505 \u1496 \u1512 \u1493 \u1504 \u1488 \u1493 \u1496 \u1497 \u1514 ',\
    prize: '\uc0\u55357 \u56960 '\
  \},\
  \{ \
    id: 3, \
    ...
    avatar: '\uc0\u55357 \u56338 ',\
    avatarName: (gender) => gender === 'male' ? '\uc0\u1511 \u1493 \u1507  \u1492 \u1512 \u1508 \u1514 \u1511 \u1503 ' : '\u1511 \u1493 \u1508 \u1492  \u1492 \u1512 \u1508 \u1514 \u1511 \u1504 \u1497 \u1514 ',\
    prize: '\uc0\u55356 \u57164 '\
  \},\
  \{ \
    id: 4, \
...
const getDifficultySettings = (diff, challengeIdx) => \{\
  const baseTime = diff === '\uc0\u1511 \u1500 ' ? 45 : diff === '\u1489 \u1497 \u1504 \u1493 \u1504 \u1497 ' ? 30 : 20;\
  ...
  return (\
    <div className="flex flex-col items-center justify-center font-mono text-4xl md:text-5xl text-slate-800" dir="ltr">\
      ...
      <div className="h-8 text-sm font-sans text-blue-600 mb-2 font-bold transition-opacity text-center w-full" dir="rtl">\
        \{activeCarry && !isStatic ? t('\uc0\u1499 \u1514 \u1493 \u1489  \u1499 \u1488 \u1503  \u1488 \u1514  \u1492 \u1492 \u1502 \u1512 \u1492  \u1513 \u1500  \u1492 \u1505 \u1508 \u1512 \u1492  \u1513 \u1499 \u1488 \u1503  \u1500 \u1502 \u1496 \u1492  \u55357 \u56391 \u55356 \u57340 ', '\u1499 \u1514 \u1489 \u1497  \u1499 \u1488 \u1503  \u1488 \u1514  \u1492 \u1492 \u1502 \u1512 \u1492  \u1513 \u1500  \u1492 \u1505 \u1508 \u1512 \u1492  \u1513 \u1499 \u1488 \u1503  \u1500 \u1502 \u1496 \u1492  \u55357 \u56391 \u55356 \u57340 ') : ''\}\
      </div>\
\
      <div className="flex justify-end gap-2 w-48 mb-2 pr-2 relative">\
        <div className="flex flex-col items-center">\
          <span className="text-[10px] text-slate-400 font-sans mb-1">\uc0\u1492 \u1502 \u1512 \u1492 </span>\
          \{!isStatic ? (\
            <input\
...
export default function App() \{\
  ...
  const [difficulty, setDifficulty] = useState('\uc0\u1489 \u1497 \u1504 \u1493 \u1504 \u1497 ');\
  \
...
\
      ...
      link.download = `\uc0\u1492 \u1514 \u1506 \u1493 \u1491 \u1492 _\u1513 \u1500 _$\{userName\}.png`;\
      link.href = dataUrl;\
      link.click();\
\
      if (navigator.share) \{\
        ...
        if (navigator.canShare && navigator.canShare(\{ files: [file] \})) \{\
          await navigator.share(\{\
            title: '\uc0\u1492 \u1514 \u1506 \u1493 \u1491 \u1492  \u1513 \u1500 \u1497 ',\
            text: `\uc0\u1492 \u1492 \u1497 \u1513 \u1490 \u1497 \u1501  \u1513 \u1500 \u1497  \u1489 \u1502 \u1513 \u1495 \u1511  \u1513 \u1500  \u1489 \u1523 2! \u1508 \u1512 \u1505 \u1497 \u1501 : $\{earnedPrizes.join(' ')\}`,\
            files: [file]\
          \});\
        \}\
      \}\
      ...
      <div className="w-full h-full max-w-4xl bg-white rounded-[2rem] shadow-2xl overflow-hidden relative flex flex-col">\
        ...
        \{screen === 'welcome' && (\
          <div className="flex flex-col items-center justify-center flex-1 text-center p-6 bg-gradient-to-br from-blue-500 to-purple-600 text-white relative">\
            ...
            <h1 className="text-5xl font-bold mb-4">\uc0\u1492 \u1502 \u1513 \u1495 \u1511  \u1513 \u1500  \u1489 \u1523 2</h1>\
            <p className="text-xl mb-10 max-w-md">\uc0\u1489 \u1512 \u1493 \u1499 \u1497 \u1501  \u1492 \u1489 \u1488 \u1497 \u1501  \u1500 \u1488 \u1514 \u1490 \u1512  \u1492 \u1495 \u1513 \u1489 \u1493 \u1503  \u1492 \u1490 \u1491 \u1493 \u1500 ! \u1502 \u1493 \u1499 \u1504 \u1497 \u1501  \u1500 \u1510 \u1488 \u1514  \u1500 \u1502 \u1505 \u1506 ?</p>\
            <button \
...
\
        ...
        \{screen === 'setup' && (\
          <div className="flex flex-col items-center justify-center flex-1 p-8 bg-white text-slate-800">\
            ...
            <h2 className="text-3xl font-bold mb-8">\uc0\u1505 \u1508 \u1512 \u1493  \u1500 \u1504 \u1493  \u1506 \u1500 \u1497 \u1499 \u1501 </h2>\
            \
            <div className="w-full max-w-sm space-y-6">\
              <div>\
                <label className="block text-sm font-medium mb-2">\uc0\u1488 \u1497 \u1498  \u1511 \u1493 \u1512 \u1488 \u1497 \u1501  \u1500 \u1498 ?</label>\
                <input \
                  type="text" \
                  value=\{userName\}\
                  onChange=\{(e) => setUserName(e.target.value)\}\
                  className="w-full p-3 border-2 border-slate-200 rounded-xl focus:border-blue-500 outline-none text-center text-xl"\
                  placeholder="\uc0\u1492 \u1513 \u1501  \u1513 \u1500 \u1498  \u1499 \u1488 \u1503 "\
                />\
              </div>\
\
              <div>\
                <label className="block text-sm font-medium mb-2">\uc0\u1488 \u1504 \u1497 ...</label>\
                <div className="flex gap-4">\
                  ...
                  >\uc0\u1513 \u1495 \u1511 \u1504 \u1497 \u1514  \u55357 \u56423 </button>\
                </div>\
              </div>\
\
              <div>\
                <label className="block text-sm font-medium mb-2">\uc0\u1512 \u1502 \u1514  \u1511 \u1493 \u1513 \u1497 </label>\
                <div className="flex gap-2">\
                  \{['\uc0\u1511 \u1500 ', '\u1489 \u1497 \u1504 \u1493 \u1504 \u1497 ', '\u1511 \u1513 \u1492 '].map(d => (\
...
\
              ...
              >\
                \{t('\uc0\u1502 \u1493 \u1499 \u1503 ?', '\u1502 \u1493 \u1499 \u1504 \u1492 ?')\} <ArrowLeft size=\{24\} />\
              </button>\
            </div>\
          </div>\
        )\}\
        ...
        \{screen === 'map' && (\
          <div className="flex flex-col flex-1 bg-slate-800 text-white relative">\
            <div className="p-4 bg-slate-900 flex justify-between items-center shadow-md z-10">\
              <h2 className="text-2xl font-bold flex items-center gap-2"><Map /> \uc0\u1502 \u1508 \u1514  \u1492 \u1488 \u1514 \u1490 \u1512 \u1497 \u1501 </h2>\
              <div className="flex items-center gap-2 text-yellow-400 font-bold bg-slate-800 px-4 py-1 rounded-full border border-slate-700">\
                \uc0\u1508 \u1512 \u1505 \u1497 \u1501 : \{earnedPrizes.length === 0 ? '\u1488 \u1497 \u1503  \u1506 \u1491 \u1497 \u1497 \u1503 ' : earnedPrizes.join(' ')\}\
              </div>\
            </div>\
            \
                  ...
                  <div key=\{th.id\} className="relative z-10 w-full max-w-sm">\
                    ...
                    >\
                      ...
                      <div className="flex-1 text-right">\
                        ...
                        <div className="text-sm opacity-80">\{isDone ? '\uc0\u1492 \u1493 \u1513 \u1500 \u1501 !' : isCurrent ? '\u1492 \u1488 \u1514 \u1490 \u1512  \u1492 \u1489 \u1488  \u1513 \u1500 \u1498 ' : '\u1504 \u1506 \u1493 \u1500 '\}</div>\
                      </div>\
        ...
        \{screen === 'challengeIntro' && (\
          <div className="flex flex-col items-center justify-center flex-1 text-center p-6 text-white relative bg-cover bg-center" style=\{\{ backgroundImage: `url($\{theme.bg\})` \}\}>\
            ...
            <button onClick=\{() => setScreen('map')\} className="absolute top-4 right-4 z-20 flex items-center gap-2 bg-black/40 hover:bg-black/60 px-4 py-2 rounded-full transition-colors font-bold border border-white/20">\
              <Home size=\{20\} /> \uc0\u1495 \u1494 \u1512 \u1492  \u1500 \u1502 \u1508 \u1492 \
            </button>\
\
            <div className="relative z-10 bg-white/20 p-10 rounded-3xl border border-white/30 backdrop-blur-md shadow-2xl max-w-lg w-full">\
              ...
              <h2 className="text-4xl font-bold mb-4">\{t('\uc0\u1489 \u1512 \u1493 \u1498  \u1492 \u1489 \u1488 ', '\u1489 \u1512 \u1493 \u1499 \u1492  \u1492 \u1489 \u1488 \u1492 ')\} \u1500 \{theme.name\}!</h2>\
              <p className="text-2xl mb-8">\
                <span className="font-bold">\{userName\}</span>, \uc0\u1492 \{theme.avatarName(gender)\} \u1513 \u1500 \u1504 \u1493  \{theme.avatar\}, \{t('\u1489 \u1493 \u1488  \u1504 \u1512 \u1488 \u1492  \u1502 \u1492  \u1488 \u1514 \u1492  \u1497 \u1493 \u1491 \u1506 ', '\u1489 \u1493 \u1488 \u1497  \u1504 \u1512 \u1488 \u1492  \u1502 \u1492  \u1488 \u1514  \u1497 \u1493 \u1491 \u1506 \u1514 ')\}.\
              </p>\
              <button \
              ...
              >\
                \{t('\uc0\u1492 \u1514 \u1495 \u1500  \u1488 \u1514 \u1490 \u1512 !', '\u1492 \u1514 \u1495 \u1497 \u1500 \u1497  \u1488 \u1514 \u1490 \u1512 !')\}\
              </button>\
            </div>\
          </div>\
        )\}\
...
\
            <div className="relative z-10 flex flex-col items-center">\
              ...
              <h2 className="text-5xl font-bold mb-4">\uc0\u1499 \u1500  \u1492 \u1499 \u1489 \u1493 \u1491 !</h2>\
              <p className="text-2xl mb-8">\uc0\u1505 \u1497 \u1497 \u1502 \u1514  \u1488 \u1514  \u1492 \u1502 \u1513 \u1497 \u1502 \u1492  \u1492 \u1512 \u1488 \u1513 \u1493 \u1504 \u1492  \u1489 \u1488 \u1514 \u1490 \u1512  \u1492 \{theme.name\}. \{t('\u1502 \u1493 \u1499 \u1503 ', '\u1502 \u1493 \u1499 \u1504 \u1492 ')\} \u1500 \u1502 \u1513 \u1497 \u1502 \u1492  \u1492 \u1513 \u1504 \u1497 \u1497 \u1492 ?</p>\
              ...
              >\
                \uc0\u1500 \u1502 \u1513 \u1497 \u1502 \u1492  \u1492 \u1513 \u1504 \u1497 \u1497 \u1492  <ArrowLeft />\
              </button>\
            </div>\
          </div>\
        )\}\
        ...
        \{screen === 'challengeComplete' && (\
          <div className="flex flex-col items-center justify-center flex-1 p-8 bg-purple-700 text-white text-center relative overflow-hidden">\
            \{Array.from(\{length: 40\}).map((_, i) => (\
              <span key=\{i\} className="confetti" style=\{\{ left: `$\{Math.random() * 100\}%`, animationDelay: `$\{Math.random() * 2\}s` \}\}>\{['\uc0\u55356 \u57225 ','\u10024 ','\u55356 \u57286 ','\u11088 '][Math.floor(Math.random()*4)]\}</span>\
            ))\}\
            \
            <div className="relative z-10 bg-white/10 p-10 rounded-3xl backdrop-blur-md border border-white/20 shadow-2xl">\
              <h2 className="text-5xl font-bold mb-4 text-yellow-300">\uc0\u1488 \u1514 \u1490 \u1512  \u1492 \u1493 \u1513 \u1500 \u1501 !</h2>\
              <p className="text-2xl mb-6">\uc0\u1499 \u1500  \u1492 \u1499 \u1489 \u1493 \u1491  \{userName\}, \u1505 \u1497 \u1497 \u1502 \u1514  \u1488 \u1514  \u1488 \u1514 \u1490 \u1512  \u1492 \{theme.name\}!</p>\
              \
              <div className="bg-white/20 rounded-2xl p-6 mb-8 inline-block shadow-inner border border-white/10">\
                <p className="text-lg mb-2">\uc0\u1492 \u1508 \u1512 \u1505  \u1513 \u1500 \u1498 :</p>\
...
\
              <div className="flex gap-4 justify-center">\
                ...
                >\
                  <Map size=\{24\} /> \uc0\u1495 \u1494 \u1512 \u1492  \u1500 \u1502 \u1508 \u1492 \
                </button>\
              </div>\
            </div>\
          </div>\
          ...
          <div className="flex flex-col flex-1 bg-slate-100 items-center justify-center p-6 relative overflow-y-auto">\
            <div id="certificate-render" className="bg-white p-10 rounded-3xl shadow-2xl border-[10px] border-yellow-400 max-w-lg w-full text-center relative mb-6 relative">\
              ...
              <div className="relative z-10">\
                ...
                <h2 className="text-4xl font-bold text-blue-800 mb-2">\uc0\u1514 \u1506 \u1493 \u1491 \u1514  \u1492 \u1510 \u1496 \u1497 \u1497 \u1504 \u1493 \u1514 </h2>\
                <p className="text-2xl text-slate-600 mb-6">\uc0\u1500 \{gender==='male'?'\u1513 \u1495 \u1511 \u1503 ':'\u1513 \u1495 \u1511 \u1504 \u1497 \u1514 '\} \u1492 \{t('\u1488 \u1500 \u1493 \u1507 ','\u1488 \u1500 \u1493 \u1508 \u1492 ')\}:</p>\
                ...
                \
                <p className="font-bold text-slate-700 text-xl mb-4">\uc0\u1488 \u1500 \u1493  \u1492 \u1508 \u1512 \u1505 \u1497 \u1501  \u1513 \u1494 \u1499 \u1497 \u1514 \u1497  \u1489 \u1492 \u1501  \u1489 \u1502 \u1513 \u1495 \u1511  \u1513 \u1500  \u1489 \u1523 2:</p>\
                <div className="flex flex-wrap justify-center gap-4 mb-4 bg-slate-50 p-6 rounded-2xl min-h-[100px] border border-slate-200 shadow-inner">\
                  \{earnedPrizes.length > 0 \
                    ...
                    : <span className="text-slate-400 text-lg flex items-center h-full">\uc0\u1506 \u1493 \u1491  \u1488 \u1497 \u1503  \u1508 \u1512 \u1505 \u1497 \u1501 , \u1492 \u1502 \u1513 \u1497 \u1499 \u1493  \u1500 \u1513 \u1495 \u1511 !</span>\
                  \}\
                </div>\
              </div>\
            </div>\
...
\
            <div className="relative z-10 p-4 flex justify-between items-center text-white bg-black/40 backdrop-blur-md border-b border-white/10 shadow-md">\
              <div className="flex items-center gap-4">\
                <button onClick=\{() => setShowInstructions(true)\} className="p-2 bg-white/20 hover:bg-white/30 rounded-full transition-colors" title="\uc0\u1492 \u1493 \u1512 \u1488 \u1493 \u1514 ">\
                  <HelpCircle size=\{24\} />\
                </button>\
                <button onClick=\{() => setScreen('map')\} className="p-2 bg-white/20 hover:bg-white/30 rounded-full transition-colors flex items-center gap-2 font-bold px-4" title="\uc0\u1500 \u1502 \u1508 \u1492 ">\
                  <Home size=\{18\} /> \uc0\u1502 \u1508 \u1492 \
                </button>\
                <div className="flex flex-col hidden sm:flex">\
                  <span className="text-xs text-blue-200">\{theme.name\} - \uc0\u1488 \u1514 \u1490 \u1512  \{challengeIdx + 1\}/8</span>\
                  <span className="font-bold">\{userName\} \uc0\u1492 \{theme.avatarName(gender)\} \{theme.avatar\}</span>\
                </div>\
              </div>\
              ...
              <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-2xl border-4 border-blue-400 min-w-[340px] relative">\
                ...
                <div className="flex justify-between items-center mb-6 pb-4 border-b-2 border-slate-100">\
                  <div className="text-sm font-bold bg-blue-50 text-blue-700 px-4 py-2 rounded-xl border border-blue-100 shadow-sm">\
                    \uc0\u1502 \u1513 \u1497 \u1502 \u1492  \{taskIdx + 1\} | \u1514 \u1512 \u1490 \u1497 \u1500  \{exerciseIdx + 1\}/8\
                  </div>\
...
\
                ...
                >\
                  \{isSuccessAction ? '\uc0\u1499 \u1500  \u1492 \u1499 \u1489 \u1493 \u1491 ! \u9989 ' : t('\u1489 \u1491 \u1497 \u1511 \u1492 ', '\u1489 \u1491 \u1497 \u1511 \u1492 ')\}\
                </button>\
              </div>\
            </div>\
\
            ...
            \{bonusMessageVisible && (\
              <div className="absolute top-[20%] left-1/2 -translate-x-1/2 z-40 bg-yellow-400 text-black font-bold px-8 py-4 rounded-full shadow-2xl border-4 border-white text-lg text-center whitespace-nowrap animate-bounce">\
                \{t('\uc0\u1508 \u1514 \u1512 \u1514  \u1504 \u1499 \u1493 \u1503  4 \u1514 \u1512 \u1490 \u1497 \u1500 \u1497 \u1501  \u1489 \u1512 \u1510 \u1507 ! \u1497 \u1513  \u1500 \u1498  6 \u1513 \u1504 \u1497 \u1493 \u1514  \u1500 \u1514 \u1508 \u1493 \u1505  \u1488 \u1514  \u1492 \u1500 \u1489 !', '\u1508 \u1514 \u1512 \u1514  \u1504 \u1499 \u1493 \u1503  4 \u1514 \u1512 \u1490 \u1497 \u1500 \u1497 \u1501  \u1489 \u1512 \u1510 \u1507 ! \u1497 \u1513  \u1500 \u1498  6 \u1513 \u1504 \u1497 \u1493 \u1514  \u1500 \u1514 \u1508 \u1493 \u1505  \u1488 \u1514  \u1492 \u1500 \u1489 !')\}\
              </div>\
            )\}\
\
              ...
              <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">\
                <div className="flex items-center gap-6 bg-white p-8 rounded-full shadow-[0_0_50px_rgba(255,255,255,0.6)] border-8 border-yellow-300">\
                  ...
                  <div className="flex gap-2 relative top-2">\
                     <span className="anim-hand-left text-[80px]">\uc0\u55358 \u57073 </span>\
                     <span className="text-[80px] -mt-4">\uc0\u55358 \u56617 </span>\
                     <span className="anim-hand-right text-[80px]">\uc0\u55358 \u57074 </span>\
                  </div>\
            ...
            \{showInstructions && (\
              <div className="absolute inset-0 z-50 bg-black/80 flex items-center justify-center p-6 backdrop-blur-sm">\
                <div className="bg-white p-8 rounded-3xl max-w-lg w-full relative max-h-[90vh] overflow-y-auto">\
                  ...
                  <h2 className="text-3xl font-bold mb-6 text-blue-600 border-b pb-4">\uc0\u1488 \u1497 \u1498  \u1502 \u1513 \u1495 \u1511 \u1497 \u1501 ?</h2>\
                  <ul className="space-y-4 text-lg text-slate-700">\
                    <li className="flex items-start gap-3"><Timer className="text-blue-500 shrink-0 mt-1"/> <div><b>\uc0\u1492 \u1494 \u1502 \u1503  \u1512 \u1509 !</b> \u1508 \u1514 \u1512 \u1493  \u1488 \u1514  \u1492 \u1514 \u1512 \u1490 \u1497 \u1500 \u1497 \u1501  \u1500 \u1508 \u1504 \u1497  \u1513 \u1492 \u1513 \u1506 \u1493 \u1503  \u1497 \u1514 \u1488 \u1508 \u1505 .</div></li>\
                    <li className="flex items-start gap-3"><Heart className="text-red-500 shrink-0 mt-1" fill="#f43f5e"/> <div><b>\uc0\u1500 \u1489 \u1489 \u1493 \u1514 :</b> \u1496 \u1506 \u1493 \u1514  \u1488 \u1493  \u1495 \u1512 \u1497 \u1490 \u1492  \u1502 \u1492 \u1494 \u1502 \u1503  \u1502 \u1493 \u1512 \u1497 \u1491 \u1493 \u1514  \u1500 \u1489 . \u1504 \u1490 \u1502 \u1512 \u1493  \u1492 \u1500 \u1489 \u1489 \u1493 \u1514 ? \u1502 \u1514 \u1495 \u1497 \u1500 \u1497 \u1501  \u1502 \u1492 \u1514 \u1495 \u1500 \u1492 .</div></li>\
                    <li className="flex items-start gap-3"><span className="text-2xl shrink-0 leading-none">\uc0\u9997 \u65039 </span> <div><b>\u1492 \u1502 \u1512 \u1493 \u1514 :</b> \u1492 \u1513 \u1514 \u1502 \u1513 \u1493  \u1489 \u1512 \u1497 \u1489 \u1493 \u1506 \u1497 \u1501  \u1492 \u1506 \u1500 \u1497 \u1493 \u1504 \u1497 \u1501  \u1499 \u1491 \u1497  \u1500 \u1499 \u1514 \u1493 \u1489  \u1492 \u1502 \u1512 \u1493 \u1514  (\u1506 \u1513 \u1512 \u1493 \u1514  \u1488 \u1493  \u1488 \u1495 \u1491 \u1493 \u1514 ). \u1499 \u1513 \u1502 \u1511 \u1500 \u1497 \u1491 \u1497 \u1501  \u1492 \u1502 \u1512 \u1492 , \u1492 \u1505 \u1508 \u1512 \u1492  \u1500 \u1502 \u1496 \u1492  \u1514 \u1497 \u1502 \u1495 \u1511  \u1489 \u1511 \u1493 !</div></li>\
                    <li className="flex items-start gap-3"><span className="text-2xl shrink-0 leading-none">\uc0\u55356 \u57217 </span> <div><b>\u1489 \u1493 \u1504 \u1493 \u1505 :</b> 4 \u1514 \u1513 \u1493 \u1489 \u1493 \u1514  \u1504 \u1499 \u1493 \u1504 \u1493 \u1514  \u1489 \u1512 \u1510 \u1507  \u1497 \u1506 \u1504 \u1497 \u1511 \u1493  \u1500 \u1499 \u1501  \u1500 \u1489  \u1502 \u1514 \u1504 \u1492  \u1513 \u1497 \u1493 \u1508 \u1497 \u1506  \u1506 \u1500  \u1492 \u1502 \u1505 \u1498  \u1500 \u1494 \u1502 \u1503  \u1502 \u1493 \u1490 \u1489 \u1500 .</div></li>\
                  </ul>\
                  <button onClick=\{() => setShowInstructions(false)\} className="mt-8 w-full py-4 bg-green-500 text-white rounded-xl font-bold text-xl hover:bg-green-600 shadow-md">\uc0\u1492 \u1489 \u1504 \u1514 \u1497 , \u1489 \u1493 \u1488 \u1493  \u1504 \u1502 \u1513 \u1497 \u1498 !</button>\
                </div>\
              </div>\
            )\}\
          </div>\
            ...
            <div className="relative z-10 p-6 md:p-8 rounded-3xl shadow-2xl w-full max-w-md flex flex-col items-center bg-white border-t-8 border-red-500 my-auto">\
              ...
              \{feedbackType === 'timeout' && (\
                <div className="text-center mb-6">\
                  ...
                  <h2 className="text-3xl font-bold text-red-600">\uc0\u1488 \u1493 \u1497 , \u1492 \u1494 \u1502 \u1503  \u1504 \u1490 \u1502 \u1512 !</h2>\
                  <p className="text-slate-600 mt-2 font-medium">\uc0\u1488 \u1500  \u1491 \u1488 \u1490 \u1492 , \u1489 \u1493 \u1488 \u1493  \u1504 \u1512 \u1488 \u1492  \u1488 \u1497 \u1498  \u1508 \u1493 \u1514 \u1512 \u1497 \u1501  \u1488 \u1514  \u1494 \u1492 :</p>\
                </div>\
              )\}\
              \
              \{feedbackType === 'error' && (\
                <div className="text-center mb-6">\
                  ...
                  <h2 className="text-3xl font-bold text-red-600">\{t('\uc0\u1500 \u1488  \u1504 \u1493 \u1512 \u1488 , \u1514 \u1496 \u1506 \u1492  \u1493 \u1514 \u1500 \u1502 \u1491 !', '\u1500 \u1488  \u1504 \u1493 \u1512 \u1488 , \u1514 \u1496 \u1506 \u1497  \u1493 \u1514 \u1500 \u1502 \u1491 \u1497 !')\}</h2>\
                  \{confusedOperation && (\
                    <div className="bg-orange-100 text-orange-800 p-3 rounded-xl mt-4 font-bold border border-orange-200 shadow-sm text-sm">\
                      \uc0\u1504 \u1512 \u1488 \u1492  \u1513 \u1492 \u1514 \u1489 \u1500 \u1489 \u1500 \u1514  \u1489 \u1497 \u1503  \u1495 \u1497 \u1489 \u1493 \u1512  \u1500 \u1495 \u1497 \u1505 \u1493 \u1512 ! \u1513 \u1497 \u1502 \u1493  \u1500 \u1489  \u1500 \u1505 \u1497 \u1502 \u1503 .\
                    </div>\
                  )\}\
                  <p className="text-slate-600 mt-4 font-medium">\uc0\u1492 \u1504 \u1492  \u1492 \u1508 \u1514 \u1512 \u1493 \u1503  \u1492 \u1504 \u1499 \u1493 \u1503  \u1489 \u1502 \u1488 \u1493 \u1504 \u1498 :</p>\
                </div>\
              )\}\
\
...
\
              <div className="flex items-center gap-3 mb-6 bg-red-50 px-6 py-3 rounded-full border border-red-100 w-full justify-center">\
                 ...
                 <span className="text-xl font-bold text-red-600">\uc0\u1504 \u1513 \u1488 \u1512 \u1493  \u1500 \u1498  \{hearts\} \u1500 \u1489 \u1489 \u1493 \u1514 </span>\
              </div>\
\
              <button \
              ...
              >\
                ...
                <span className="relative z-10 flex items-center gap-2">\
                  \{t('\uc0\u1502 \u1502 \u1513 \u1497 \u1499 \u1497 \u1501  \u1500 \u1514 \u1512 \u1490 \u1497 \u1500  \u1492 \u1489 \u1488 ', '\u1502 \u1502 \u1513 \u1497 \u1499 \u1493 \u1514  \u1500 \u1514 \u1512 \u1490 \u1497 \u1500  \u1492 \u1489 \u1488 ')\} <ArrowLeft /> \
...
\
        ...
        \{screen === 'gameOver' && (\
          <div className="flex flex-col items-center justify-center flex-1 p-8 bg-red-600 text-white text-center relative overflow-hidden">\
            ...
            <div className="relative z-10">\
              <h2 className="text-6xl font-bold mb-6">\uc0\u1488 \u1493 \u1508 \u1505 , \u1504 \u1490 \u1502 \u1512 \u1493  \u1492 \u1500 \u1489 \u1489 \u1493 \u1514 !</h2>\
              <p className="text-2xl mb-12 max-w-lg mx-auto">\{userName\}, \uc0\u1500 \u1488  \u1511 \u1512 \u1492  \u1499 \u1500 \u1493 \u1501 . \u1499 \u1500  \{t('\u1490 \u1497 \u1489 \u1493 \u1512 ','\u1490 \u1497 \u1489 \u1493 \u1512 \u1492 ')\} \u1510 \u1512 \u1497 \u1499 \u1497 \u1501  \u1500 \u1492 \u1514 \u1488 \u1502 \u1503  \u1511 \u1510 \u1514  \u1497 \u1493 \u1514 \u1512  \u1500 \u1508 \u1506 \u1502 \u1497 \u1501 !</p>\
              <button \
                onClick=\{resetGame\}\
              ...
              >\
                <RefreshCcw size=\{32\} /> \uc0\u1502 \u1514 \u1495 \u1497 \u1500 \u1497 \u1501  \u1502 \u1492 \u1492 \u1514 \u1495 \u1500 \u1492 \
              </button>\
            </div>\
          </div>\
        )\}\
        ...
        \{screen === 'victory' && (\
          <div className="flex flex-col items-center justify-center flex-1 p-8 bg-gradient-to-br from-green-400 to-blue-500 text-white text-center relative overflow-hidden">\
            \{Array.from(\{length: 80\}).map((_, i) => (\
              <span key=\{i\} className="confetti" style=\{\{ left: `$\{Math.random() * 100\}%`, animationDelay: `$\{Math.random() * 3\}s` \}\}>\uc0\u55356 \u57225 </span>\
            ))\}\
            <div className="relative z-10">\
              <Star size=\{120\} fill="yellow" className="text-yellow-400 mb-6 animate-pulse drop-shadow-[0_0_30px_rgba(253,224,71,0.8)] mx-auto" />\
              <h2 className="text-6xl font-bold mb-4">\uc0\u1504 \u1497 \u1510 \u1495 \u1493 \u1503  \u1488 \u1491 \u1497 \u1512 ! \u55356 \u57286 </h2>\
              <p className="text-3xl mb-12 max-w-xl mx-auto leading-relaxed font-medium">\uc0\u1499 \u1500  \u1492 \u1499 \u1489 \u1493 \u1491  \{userName\}! \u1505 \u1497 \u1497 \u1502 \u1514  \u1488 \u1514  \u1499 \u1500  \u1492 \u1488 \u1514 \u1490 \u1512 \u1497 \u1501  \u1513 \u1500  \u1489 '2 \u1493 \u1492 \u1493 \u1499 \u1495 \u1514  \u1513 \u1488 \u1514 /\u1492  \{t('\u1488 \u1500 \u1493 \u1507 ', '\u1488 \u1500 \u1493 \u1508 \u1492 ')\} \u1488 \u1502 \u1497 \u1514 \u1497 /\u1514  \u1489 \u1495 \u1513 \u1489 \u1493 \u1503 !</p>\
              <div className="flex gap-4 justify-center">\
                <button \
